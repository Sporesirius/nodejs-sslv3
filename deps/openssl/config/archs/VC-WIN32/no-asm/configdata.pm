...
our %config = (
  ...
  perl_version => "5.26.1",
  perlargv => [ "no-comp", "no-shared", "no-afalgeng", "enable-ssl-trace", "enable-ssl3", "enable-ssl3-method", "enable-weak-ssl-ciphers", "no-asm", "VC-WIN32" ],
  perlenv => {
      "AR" => undef,
      "ARFLAGS" => undef,
      "AS" => undef,
